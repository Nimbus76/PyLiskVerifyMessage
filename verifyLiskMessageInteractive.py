...
def main():
    ...
    while check_another == True:
        ...
        try:
            ...
            check_another = success(message, verified_message, public_key, lisk_address)
...
def digestMessage(message):
    ...
    dataBytes = SIGNED_MESSAGE_PREFIX_LENGTH + SIGNED_MESSAGE_PREFIX_BYTES + msgLenBytes + msgBytes
